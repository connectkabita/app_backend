...
public class DepartmentController {
    ...
    @GetMapping("/{id}") public Department getById(@PathVariable Integer id){ return svc.getById(id); }
    @PutMapping("/{id}") public Department update(@PathVariable Integer id,@RequestBody Department d){ return svc.update(id,d); }
